...
( cs = function( options ) {
	...
	*/
	...
	collapse : function( frame ) {
		frame = typeof frame !== 'undefined' && typeof frame !== 'string' && frame !== '' ?
						frame :
						__me.name;
	...
	*/
	...
	track : function( urls, complete ) {
		...
		function track( url, complete ) {
			...
			var $this = this;
			url	= url.replace( /\$random\$|\[timestamp\]/gi, +new Date() );
			var img	= '<img src="' + url + '" height="0" width="0" border="0"/>';
...
cs.fn.frame.fn = {
	...
	collapse : function( frame ) {
		frame = typeof frame !== 'undefined' && typeof frame !== 'string' && frame !== '' ? frame : __me.name;
	...
	popout : function( context, html, before, complete ) {
		...
		before	= typeof before !== 'undefined' && typeof before === 'boolean' ? before : false;
